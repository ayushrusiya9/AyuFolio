      ...
      <div className="section pb-5">
        <div className="flex flex-wrap justify-between ">
          <div className="w-full sm:w-3/5 lg:w-2/5 pr-2">
            <AnimatedWrapper>
              <h3 className="text-white text-2xl md:text-3xl font-bold pb-2">
                Ayush Rusiya
              </h3>
              <p className="text-lg text-cyan-400 pb-4">Python Full Stack Developer</p>
              <p className="text-gray-300 pb-2">Welcome to my portfolio, AyuFolio.</p>
              <p className="text-gray-300 pb-2">Connect with me on social links below.</p>
              <p className="text-gray-300">Got suggestions? Type them above!</p>
            </AnimatedWrapper>
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col  gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
                <div className="text-[0.9rem] font-advanced">
                  <p className="flex items-center gap-3 mb-1">
                    <GMail /> ayushrusiya386@gmail.com
                  </p>
                  <p className="flex items-center gap-3 ">
                    {" "}
                    <Map />
                    <span className="pt-1">Bhopal, Madhya Pradesh, India</span>
                  </p>
                </div>
